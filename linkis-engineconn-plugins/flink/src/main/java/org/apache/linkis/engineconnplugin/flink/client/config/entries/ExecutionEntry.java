...
public class ExecutionEntry extends ConfigEntry {
  ...
  public static final List<String> AVAILABLE_PLANNERS =
      Arrays.asList(
          ExecutionEntry.EXECUTION_PLANNER_VALUE_OLD, ExecutionEntry.EXECUTION_PLANNER_VALUE_BLINK);

  public static final List<String> AVAILABLE_EXECUTION_TYPES =
      Arrays.asList(
          ExecutionEntry.EXECUTION_TYPE_VALUE_BATCH, ExecutionEntry.EXECUTION_TYPE_VALUE_STREAMING);
  ...
  private ExecutionEntry(DescriptorProperties properties) throws FlinkInitFailedException {
    super(properties);
  }
...
//    }
  ...
  public static ExecutionEntry create(Map<String, Object> config) throws FlinkInitFailedException {
  ...
  public static ExecutionEntry merge(ExecutionEntry execution1, ExecutionEntry execution2)
      throws FlinkInitFailedException {
  ...
  /**
   * Creates a new execution entry enriched with additional properties that are prefixed with {@link
